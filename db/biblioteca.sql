...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2026 a las 03:05:09
...
(1, 'webadmin', '$2y$10$pfrfYB6ufzuPax4vK7j5n.y5Q1tO7NoiVBrrqGFiF.mI9oQzxzmZe');
...
WHERE EXISTS {
  SELECT 1
  FROM pedido p
  JOIN direccion_entrega de ON p.id_direccion 
